...
lw_1.lw.onDispose(vscode.window.onDidChangeActiveTextEditor(e => {
    state.editor = lw_1.lw.file.hasTexLangId(e?.document.languageId ?? '') ? e : undefined;
}));
...
const state = {
    view: undefined,
    editor: lw_1.lw.file.hasTexLangId(vscode.window.activeTextEditor?.document.languageId ?? '') ? vscode.window.activeTextEditor : undefined,
    callbacks: new Set()
};
exports.state = state;
