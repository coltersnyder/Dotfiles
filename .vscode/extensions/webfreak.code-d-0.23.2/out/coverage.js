...
class CoverageAnalyzer {
    ...
    populateCurrent() {
        ...
        if ((0, extension_1.config)(editor.document.uri).get("enableCoverageDecoration", true)) {
    ...
    refreshStatusBar(editor) {
        if (this.gotCoverage && (0, statusbar_1.checkStatusbarVisibility)("alwaysShowCoverageStatus", editor))
