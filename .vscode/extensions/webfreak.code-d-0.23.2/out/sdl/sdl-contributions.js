...
exports.SDLContributions = exports.addSDLProviders = void 0;
...
function completeDubVersion(info) {
    ...
    return new Promise((resolve) => {
        (0, dub_api_1.getPackageInfo)(packageName).then(json => {
            ...
            results.sort((a, b) => (0, installer_1.cmpSemver)(typeof b.label == "string" ? b.label : b.label.label, typeof a.label == "string" ? a.label : a.label.label));
...
class SDLContributions {
    provideCompletionItems(document, position, token) {
        ...
        try {
            var info = (0, sdlinfo_1.getLocationInfo)(document, position);
            console.log(info);
            if (info.namespace[0] != "")
    ...
    provideDiagnostics(document) {
        var root = (0, sdlparse_1.parseSDL)(document.getText());
        let errors = [];
        function range(r) {
            if (!r)
