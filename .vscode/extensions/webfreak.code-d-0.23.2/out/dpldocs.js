...
exports.loadDependencySymbolsOnline = exports.fillDplDocs = exports.showDpldocsSearch = void 0;
...
function fillDplDocs(panel, label, href) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let body = (yield (0, util_1.reqText)().get(href)).data;
        let content = new jsdom_1.JSDOM(body);
...
function loadDependencySymbolsOnline(dep, strippedDependencyName, strippedDependencyVersion) {
    ...
    let doTry = function (url) {
        return (0, util_1.reqText)().get(url, { headers: { "Accept-Encoding": "gzip" } }).then((body) => {
            if (body.status == 200) {
...
function updateRootSearchQuery(timeout, value, state, delay = 500) {
    ...
    return setTimeout(() => __awaiter(this, void 0, void 0, function* () {
        ...
        state.startWork();
        try {
            let body = (yield (0, util_1.reqText)().get("https://dpldocs.info/locate?q=" + encodeURIComponent(value))).data;
            state.finishWork();
            state.items = [];
