...
exports.StartupProgress = exports.checkStatusbarVisibility = exports.isStatusbarRelevantDocument = exports.setupDub = void 0;
...
function checkStatusbarVisibility(overrideConfig, editor) {
    if (editor === null) {
        if ((0, extension_1.config)(null).get(overrideConfig, false))
            return true;
        else
            return false;
    }
        ...
        if (editor) {
            if ((0, extension_1.config)(editor.document.uri).get(overrideConfig, false) || isStatusbarRelevantDocument(editor.document))
                return true;
            else
                return false;
        }
