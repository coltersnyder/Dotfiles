...
exports.JSONProvider = exports.addJSONProviders = void 0;
...
class JSONProvider {
    ...
    provideHover(document, position, token) {
        ...
        let location = (0, jsonc_parser_1.getLocation)(document.getText(), offset);
    ...
    provideCompletionItems(document, position, token) {
        ...
        if (location.isAtPropertyKey) {
            ...
            let scanner = (0, jsonc_parser_1.createScanner)(document.getText(), true);
