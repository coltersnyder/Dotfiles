...
exports.cmpSemver = exports.parseSimpleSemver = exports.compileDependency = exports.compileServeD = exports.extractServedBuiltDate = exports.installServeD = exports.updateAndInstallServeD = exports.findLatestServeD = exports.downloadFileInteractive = exports.getInstallOutput = exports.determineOutputFolder = exports.setContext = void 0;
...
exports.determineOutputFolder = determineOutputFolder;
var installationLog;
...
function downloadFileInteractive(url, title, aborted) {
    ...
    let cancel;
    let done;
    let stream = (0, util_1.reqType)("stream").get(url).then((body) => {
...
function findLatestServeD(force = false, channel) {
    if (!channel)
        channel = (0, extension_1.config)(null).get("servedReleaseChannel", "stable");
    if (channel == "frozen" && force)
        channel = "stable";
    if (channel == "frozen" || (0, extension_1.config)(null).get("forceCompileServeD", false))
        return Promise.resolve(undefined);
    if (servedVersionCache.channel == channel)
        return Promise.resolve(servedVersionCache.release);
    let randomUpdateReduction = (0, extension_1.config)(null).get("smartServedUpdates", true);
...
function fetchNightlyRelease(timeout) {
    return __awaiter(this, void 0, void 0, function* () {
        let res;
        try {
            res = yield (0, util_1.reqJson)().get("https://api.github.com/repos/Pure-D/serve-d/releases/" + nightlyReleaseId, {
                headers: {
...
function fetchLatestTaggedRelease(channel, timeout) {
    return __awaiter(this, void 0, void 0, function* () {
        let res;
        try {
            res = yield (0, util_1.reqJson)().get("https://api.github.com/repos/Pure-D/serve-d/releases", {
                headers: {
                    "User-Agent": "https://github.com/Pure-D/code-d"
                },
                timeout: timeout
...
function updateAndInstallServeD(env) {
    return vscode.window.withProgress({
        ...
        return findLatestServeD(true).then((version) => {
            ...
            else if (!version.asset || (0, extension_1.config)(null).get("forceCompileServeD", false)) {
                return compileServeD("master")(env);
            }
            else {
        ...
        async.each(urls, installServeDEntry(outputFolder), function (err) {
            return __awaiter(this, void 0, void 0, function* () {
                if (err) {
                    ...
                    yield (0, extension_1.config)(null).update("servedPath", finalDestination, true);
...
function compileServeD(ref) {
    return (env) => new Promise(() => __awaiter(this, void 0, void 0, function* () {
        var outputFolder = determineOutputFolder();
        mkdirp.sync(outputFolder);
        const dubPath = (0, extension_1.config)(null).get("dubPath", "dub");
        const dmdPath = (0, extension_1.config)(null).get("dmdPath", undefined);
        const dubCompiler = (0, extension_1.config)(null).get("dubCompiler", undefined);
