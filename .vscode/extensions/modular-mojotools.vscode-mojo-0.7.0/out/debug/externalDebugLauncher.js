...
class RpcLaunchServer extends disposableContext_1.DisposableContext {
     ...
     * safety mechanism.
     */
    constructor(loggingService, port, token) {
        super();
        this.tokens = new Set();
    ...
    processRequest(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let success = yield vscode_1.debug.startDebugging(/*workspaceFolder=*/ undefined, debugConfig);
    ...
    listen() {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise(resolve => this.inner.listen({ port: this.port, host: "127.0.0.1" }, () => resolve(this.inner.address() || "")));
        });
    }
    /**
