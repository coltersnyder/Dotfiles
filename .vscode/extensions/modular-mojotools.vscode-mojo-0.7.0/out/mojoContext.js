...
class MOJOContext extends disposableContext_1.DisposableContext {
    constructor(extensionContext, loggingService) {
        super();
        this.workspaceClients = new Map();
        this.extensionContext = extensionContext;
        this.loggingService = loggingService;
        this.sdk = new mojoSDK_1.MOJOSDK(this.loggingService);
    }
    /**
     *  Activate the Mojo context, and start the language clients.
     */
    activate(launchLanguageServerSuspended = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.pushSubscription(vscode.commands.registerCommand('mojo.restart-suspended', () => __awaiter(this, void 0, void 0, function* () {
                // Dispose and reactivate the context.
                this.dispose();
                yield this.activate(/*launchLanguageServerSuspended=*/ true);
            })));
            ...
            this.pushSubscription((0, formatter_1.registerFormatter)(this.loggingService, this.sdk));
            ...
            this.pushSubscription(new decorations_1.MojoDecoratorContext());
    ...
    getOrActivateLanguageClient(uri, launchLanguageServerSuspended) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!client) {
                client = yield this.activateWorkspaceFolder(workspaceFolder, this.loggingService, launchLanguageServerSuspended);
                if (client) {
    ...
    startLanguageClient(workspaceFolder, loggingService, launchLanguageServerSuspended) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // functionality.
            let mojoConfig = yield this.sdk.resolveConfig(workspaceFolder);
            if (!mojoConfig)
                return [undefined, ""];
            let args = [];
            if (launchLanguageServerSuspended)
                args.push("--suspended");
            if (config.get("lsp.parseStdlib", workspaceFolder, false))
