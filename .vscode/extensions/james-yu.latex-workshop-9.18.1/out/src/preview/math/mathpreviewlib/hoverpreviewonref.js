...
class HoverPreviewOnRefProvider {
    static async provideHoverPreviewOnRef(tex, macros, refData, color) {
    ...
    static async renderSvgOnRef(tex, macros, refData, color) {
        ...
        const typesetArg = macros + mathpreviewutils_1.MathPreviewUtils.stripTeX(newTeXString, macros);
